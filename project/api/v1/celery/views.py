...
class CeleryResultView(APIView):
    ...
    def get(self, request, pk):
        ...
        Поле status может иметь статусы
        SUCCESS, FAILURE, PENDING и другие. которые для фронта не важны.

        SUCCESS - задача выполнилась успешно.
        FAILURE - выполнение задачи завершилось ошибкой.
        PENDING - задача выполняется.
        В поле result - может быть что угодно.
        Сериализатор не даст вывести правильный возвращаемый тип.
